...
import sys
# SMS BOMBER
# https://github.com/flam3arafat
# Tools BY Flam3arafat
def mainmenu():  
    hedr()
    key = 0
...
│   |_|_\___|_| |___/_/ \_\_| |___|_|_\ 
  ...
  SMS Repeater: github.com/flam3arafat \033[1;0m
  """)   
  try:
...
def hedr():
    ...
    smsrepeater.addstr(10, 4, " SMS Repeater: github.com/flam3arafat   ", curses.color_pair(1))      
    #smsrepeater.endwin()
def LogicLoop():
    mainmenu()
try:
